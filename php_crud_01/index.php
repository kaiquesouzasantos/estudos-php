      ...
      <div class="col-6">
        <div class="jumbotron">
          ...
          <form action="index.php" method="POST">
            ...
            <button type="submit" class="btn btn-success" id="submit">Acessar</button>
          </form>
          ...
          <?php   
                  if (isset($_POST['login'])) {
                    ...
                    /*
                      INSERT INTO `usuarios`(`nome`, `login`, `senha`) VALUES ('teste','teste',md5('teste'));
                      
                      md5(<senha>) cripitografa a senha 
                    */
